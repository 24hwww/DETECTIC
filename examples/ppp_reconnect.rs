...
fn main() {
    ...
    for attempt in 1..=10u32 {
        ...
        match c.connect() {
            ...
            Err(e) => {
                eprintln!("[retry {attempt}] login: {e}");
    ...
    println!(
        "PRE : v4={} ip={} gw={} v6={}",
        field(&list, "connStatusV4"),
        field(&list, "connIPv4Address"),
        field(&list, "connIPv4Gateway"),
        field(&list, "connStatusV6")
    );
    ...
    println!(
        ...
        t.op_with_data(
            "ACT_PPP_DISCONN",
            r#"{"stack":"1,0,0,0,0,0","pstack":"0,0,0,0,0,0"}"#
        )
        .unwrap()
    );
